...
I used the distinct() function to select just the exact column I want to evaluate for the plots. I used color brewer, imported the package, then realized it was awful so I commented it outand used a hex color. 
